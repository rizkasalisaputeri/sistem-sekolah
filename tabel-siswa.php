...
if(isset($_POST['add'])){
  ...
  $tgl_alamat= $_POST['tgl_alamat'];
  $anakke= $_POST['anakke'];

  $data->store($noinduk_siswa, $NIK_walmur, $jenis_kelamin, $tgllahir,$tgl_masuk, $tgl_lulus,$tgl_alamat, $anakke);
...
if(isset($_POST['update'])){
  ...
  $data->update($noinduk_siswa,$alamat) ;
  ...
  <section class="section dashboard">
                ...
                <table class="table table-striped">
                  ...
                  <?php foreach($data->show() as $value){
                    ...
                    <tr>
                      ...
                      <td>'.$value['anakke'].'</td>
                      <td>
                      <button  class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete'.$value['noinduk_siswa'].'">Hapus</button>
                      <button  class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#update'.$value['noinduk_siswa'].'">Edit</button>
                      </td>
                    </tr>';
                  }?>
                  </tbody>
      ...
      <?php foreach ($data->show() as $value){
        echo '
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="" method="post">
                                <input type="hidden" name="noinduk_siswa" value="'.$value['noinduk_siswa'].'" class="form-control col-6">
            ...
            <?php foreach ($data->show() as $value){
        echo'
            <div id="delete'.$value['noinduk_siswa'].'" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="mt-1">
                                ...
                                <p>Apakah benar anda ingin menghapus data '.$value['noinduk_siswa'].'?</p>
                            </div>
                            <div class="d-flex flex-row-reverse mt-3">
                                <form action="" method="post">
                                    <input type="hidden" name="id_rapor" value="'.$value['noinduk_siswa'].'" class="form-control col-6">
